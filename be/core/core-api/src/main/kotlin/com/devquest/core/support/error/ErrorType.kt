...
enum class ErrorType(val status: HttpStatus, val code: ErrorCode, val message: String) {
    ...
    COMPANY_JD_NOT_REGISTERED(HttpStatus.BAD_REQUEST, ErrorCode.COMPANY_JD_NOT_REGISTERED, ErrorCode.COMPANY_JD_NOT_REGISTERED.message),
    RESUME_NOT_REGISTERED(HttpStatus.BAD_REQUEST, ErrorCode.RESUME_NOT_REGISTERED, ErrorCode.RESUME_NOT_REGISTERED.message)
}
