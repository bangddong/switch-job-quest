...
| 🔴 **영속 EBS** `vol-0518b6d0dcd2b0d70` 10GiB gp3 | **2026-07-31** | **없음 (destroy해도 남음)** | **≈ $0.91/월** | **$199.02 / $200** (08-11 실측) |

> 📌 **누적 소진 실측 $0.977** (2026-08-11, `RECORD_TYPE` 분리 조회):
> 7월 `$0.4877` + 8월 `$0.4891`. 8월분은 08-07 유료 세션(97분 ≈ $0.21) + 영속 EBS 일할분이다.
> 크레딧 만료 2027-01-15까지 **0.49% 소진**.
...
## 2026-08-11 — 무과금 재현 검증 (정적 대조) · 비용 $0
