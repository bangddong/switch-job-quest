...
| 항목 | 내용 |
|------|------|
| 브랜치 | `chore/grafana-ai-metrics-dashboard-iac` |
| 열린 PR | #236 — Grafana AI Metrics 토큰 패널 table 전환 + 대시보드 v2 스키마 IaC 동기화 (머지 대기) |
...
- [ ] 기술면접 질문 뱅크(#231) 콘텐츠 확충 — mneme wiki `tech/`, `ai-llm/` 카테고리 지식 쌓이는 대로
